...
Since we're interested in relative bias (not absolute bias as with the point estimates because we're not interested in whether estimates are more negative or positive), we'll calculate bias as above but divide by the estimand and multiply by 100.
