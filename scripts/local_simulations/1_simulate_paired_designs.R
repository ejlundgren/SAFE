...
# Now calculate true point estimands:
lnrom_out <- eff_size(x1 = bias_df$true_mean1, x2 = bias_df$true_mean2,
                      sd1 = bias_df$true_sd1, sd2 = bias_df$true_sd2,
                      n = bias_df$n, r = bias_df$r,
...
smd_out <- eff_size(x1 = sim_dat$sim_mean1, x2 = sim_dat$sim_mean2,
                    ...
                    verbose = FALSE,
                    SAFE_boots = 1e6) 
smd_out[, effect_type := "lnRoM_paired"]
