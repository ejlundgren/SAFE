...
We have now calculated sampling variance for Q~10~! This sampling variance can then be used be in a meta-analytic model, like any other sampling variance:
